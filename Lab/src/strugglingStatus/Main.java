...
//PROBLEM NUMBER ONE: FIVE RANDOM NUMBERS
    ...
    System.out.println("Type out any number on five lines below: ");
...
//PROBLEM NUMBER TWO : CARS
        ...
        if (vehicles.containsKey(carChoice)) {
            System.out.println("Great! We have that model. ");
            ...
            System.out.println(carChoice + "? Sorry, but we don't carry that model.");
